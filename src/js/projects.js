export const projects = [
    {
        ...
        date: "August 2023",
        tech_stack: "React.js, HTML, CSS, API, Git, VS Code",
        tasks: [
            "Developed the user interface and user experience for a Medium.com clone from scratch using React.js.",
            "Integrated user authentication systems, allowing users to register, log in, and maintain personalized profiles.",
            "Collaborated closely with the Ruby on Rails backend developer to integrate the frontend with the backend API."
        ],
        github_repo: "https://github.com/Abhiiim/Medium-blogs"
    }, {
        title: "Organisational Hierarchy",
        date: "March 2022",
        tech_stack: "Java, AVL Tree, Graph, DSA",
        tasks: [
        ...
        title: "Todo List", 
        date: "July 2023",
        tech_stack: "JavaScript, HTML, CSS, Git",
        tasks: [
